...
do
  ...
  if [ ${#proc} -eq 0 ]; then
    ...
    gdalwarp -t_srs EPSG:3857 -s_srs \
       '+proj=lcc +lat_1=25 +lat_2=25 +lat_0=25 +lon_0=265 +x_0=0 +y_0=0 +a=6371229 +b=6371229 +units=m +no_defs ' \
       $f -of Gtiff /home/tcook/gs/data_dir/data/ect/$2/ECT_$2_latest_3857_tmp.tiff

    # now overwrite existing file
    mv  /home/tcook/gs/data_dir/data/ect/$2/ECT_$2_latest_3857_tmp.tiff \
         /home/tcook/gs/data_dir/data/ect/$2/ECT_$2_latest_3857.tiff
